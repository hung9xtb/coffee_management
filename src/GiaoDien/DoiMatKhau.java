...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        byte[] md5InBytes = AccountDAO.digest(txtPassOld.getText().getBytes(UTF_8));
        String textOld = AccountDAO.bytesToHex(md5InBytes);
        if (!textOld.equals(AccountDAO.getInstance().GetAccount().getPassword())) {
